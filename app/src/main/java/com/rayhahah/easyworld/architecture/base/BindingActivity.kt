...
import com.rayhahah.libbase.base.BaseActivity
import com.rayhahah.libbase.utils.BarUtils
...
abstract class BindingActivity : BaseActivity() {
    ...
    protected fun getAppViewModelProvider(
        ...
        return (applicationContext as MyApp).getAppViewModelProvider(this, factory)
    }
}