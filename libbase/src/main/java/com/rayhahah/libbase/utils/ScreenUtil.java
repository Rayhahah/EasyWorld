...
public class ScreenUtil {
    ...
    public static void obtainContentHeight(View view) {
        int offset = getStatusBarHeight(BaseApp.getAppContext()) + getActionBarHeight(BaseApp.getAppContext());
        ViewGroup.LayoutParams lp = view.getLayoutParams();
        lp.height = getScreenHeight(BaseApp.getAppContext()) - offset;
