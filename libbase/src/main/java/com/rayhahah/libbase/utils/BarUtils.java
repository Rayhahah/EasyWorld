...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (BaseApp.getAppContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, BaseApp.getAppContext().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = BaseApp.getAppContext().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = BaseApp.getAppContext()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) BaseApp.getAppContext().getSystemService(Context.WINDOW_SERVICE);
            if (wm == null) {
                return false;
            }
        ...
        boolean menu = ViewConfiguration.get(BaseApp.getAppContext()).hasPermanentMenuKey();
